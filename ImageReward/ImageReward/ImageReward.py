...
class ImageReward(nn.Module):
    ...
    def inference_rank_multiple_prompts(self, prompt_list, generations_list):
        
        assert len(prompt_list) == len(generations_list), "The length of prompt_list and generations_list should be the same."
